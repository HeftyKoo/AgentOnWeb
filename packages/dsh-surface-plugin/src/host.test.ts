...
describe("DSH native authorization CSRF guard", () => {
  it("uses the original Host, not DSH's internal Fetch URL", () => {
    const request = (headers: Record<string, string>) => new Request("http://dsh.internal/api/overcode/connections", {
